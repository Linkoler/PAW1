...
class PersonEditCtrl {
	...
	public function validateSave() {
		...
		$this->form->tele = getFromRequest('tele',true,'Błędne wywołanie aplikacji');
		...
		if (empty(trim($this->form->tele))) {
		    getMessages()->addError('Wprowadź tele');
		}
